...
var Weather = React.createClass({
	...
	var currentWeatherDisplay = <CurrentWeather currentCityName = {this.state.name}
     temp = {this.state.temp} weather = {this.state.weather} wind = {this.state.wind}
      humidity = {this.state.humidity} />;

    var weeklyWeatherDisplay = <WeeklyWeatherMolecule desc={this.state.desc}
       condition={this.state.condition} wind={this.state.wind} forecast={this.state.forecast} />
